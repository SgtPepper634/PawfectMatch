...
class CatColors(Enum):
    ...
    GRAY_AND_WHITE = "Gray & White"
    GRAY = "Gray / Blue / Silver"
    LILAC_POINT = "Lilac Point"
    ORANGE_AND_WHITE = "Orange & White"
    ORANGE = "Orange / Red"
    SEAL_POINT = "Seal Point"
    SMOKE = "Smoke"
    TABBY_BROWN = "Tabby (Brown / Chocolate)"
    TABBY_TAN = "Tabby (Buff / Tan / Fawn)"
    TABBY_GRAY = "Tabby (Gray / Blue / Silver)"
    TABBY_SPOTTED = "Tabby (Leopard / Spotted)"
    TABBY_ORANGE = "Tabby (Orange / Red)"
    TABBY_STRIPED = "Tabby (Tiger Striped)"
    TORBIE = "Torbie"
